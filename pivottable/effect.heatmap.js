 ...
 * @description
 */
define("pivottable/effect.heatmap", ["jquery"], function($) {
    function heatmap(scope) {
        if (scope == null) {
            scope = "heatmap"
        }
    ...
    heatmap.reset = function() {
        this.find(".pivottable-value, .pivottable-total-row, .pivottable-total-col").each(function() {
