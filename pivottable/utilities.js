...
define(["underscore"], function(_) {
    ...
    function Effect(effect, option) {
        return function(x) {
            var previousEffect = x.data("effect")
            if (previousEffect && previousEffect != effect) {
                require(["pivottable/effect." + previousEffect], function(effectFunction) {
                    effectFunction.reset.call(x)
                })
            }
            require(["pivottable/effect." + effect], function(effectFunction) {
                effectFunction.call(x, option)
                x.data("effect", effect)
            })
        }
    }
    ...
    return {
        ...
        effects: {
            ...
            "Row Barchart": new Effect("barchart"),
            "Heatmap": new Effect("heatmap"),
            "Row Heatmap": new Effect("heatmap", "rowheatmap"),
            "Col Heatmap": new Effect("heatmap", "colheatmap")
        },
